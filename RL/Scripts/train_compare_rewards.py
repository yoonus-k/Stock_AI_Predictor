...
def train_and_evaluate_models(reward_types=['base', 'sharpe', 'sortino', 'drawdown_focus', 'calmar', 'win_rate', 'combined'], 
    ...
    for reward_type in reward_types:
        ...
        env = PatternSentimentEnv(train_data, reward_type=reward_type)
        ...
        eval_env = PatternSentimentEnv(eval_data, reward_type=reward_type)
        ...
        eval_env = PatternSentimentEnv(eval_data, reward_type='base')  # Use base reward for fair comparison
