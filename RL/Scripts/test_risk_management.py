...
def test_risk_management(model_paths, data=None, stress_scenarios=['normal', 'drawdown', 'volatility', 'choppy']):
    """
    ...
    for reward_type, model_path in model_paths.items():
        ...
        try:
            ...
            for scenario_name, scenario_df in scenario_data.items():
                ...
                env = PatternSentimentEnv(scenario_df, reward_type='base')  # Using base reward for fair comparison
...
if __name__ == "__main__":
    ...
    # Run stress tests
    results = test_risk_management(model_paths)
