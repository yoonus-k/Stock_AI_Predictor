...
if __name__ == '__main__':
    data = pd.read_csv("C:/Users/yoonus/Documents/GitHub/Stock_AI_Predictor/TechnicalAnalysisAutomation/BTCUSDT3600.csv")
    data['date'] = data['date'].astype('datetime64[s]')
    data = data.set_index('date')
    data = np.log(data) # this is a hack to make the data stationary
    ...
    print(data)
    # mpf.plot(data, type='candle', style='charles', addplot=data['sig'])
