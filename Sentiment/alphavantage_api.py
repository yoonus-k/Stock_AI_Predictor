...
def get_news_sentiment_analysis(stock_ticker, date_str, api_key='80LCP07NHD21JDYE'):
    ...
    try:
        ...
        date_av = dt.strftime('%Y%m%dT%H%M')
        
        # Build API URL
        #url = f'https://www.alphavantage.co/query?function=NEWS_SENTIMENT&tickers={stock_ticker}&apikey={api_key}&time_from={date_av}&time_to={date_av}'
...
if __name__ == '__main__':
    ...
    date_str = '2025-04-10 20:34:07'  # Matches one of the articles in your sample
