...
from Data.Database.db import Database  # Adjust the import based on your project structure
# Initialize database connection
#db = Database(f"{main_dir}/Data/data.db")
...
class TwitterAPI:
    ...
    def fetch_tweets(self,query, date_from=None, date_to=None, query_type="Latest", max_tweets=1000):
        ...
        if date_from and date_to:
            ...
            # Adapt parsing here
            date_from_dt = self.format_date_for_query(date_from)
    ...
    def fetch_tweets_if_needed(self,specific_date=None, start_date=None, end_date=None, ticker_id=None, min_tweet_count=100):
        ...
        if specific_date:
            # shif the start date to the previous day
            start_date = self.format_date_for_query(specific_date) - timedelta(days=1)
    ...
    def load_tweets_from_db(self,start_date=None, end_date=None, ticker_id=0):
        ...
        try:
            ...
            start_dt = self.format_date_for_query(start_date)  if start_date else None
            ...
            if tokenizer and model:
                ...
                if 'final_weighted_sentiment' in df.columns:
                    ...
                    for idx, row in top_positive.iterrows():
                        score = row['final_weighted_sentiment']
                        tweet_text = row['tweet_text']
                        #print(f"Score: {score:.4f} | {tweet_text}")
...
if __name__ == "__main__":
    # Example parameters
    specific_date = '2024-01-16 00:00:00'  # Use specific_date for a single day
